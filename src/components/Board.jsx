...
//     if (result) setWinner(player);
//     else setTurn(player === 'player1' ? 'player2' : 'player1');
//   };
...
//       <h4>{winner ? `🎉 ${winner.toUpperCase()} Wins!` : `${turn.toUpperCase()}'s Turn`}</h4>
//       <div className="board d-grid grid-template">
//         {grid.map((cell, i) => (
//           <Cell key={i} index={i} data={cell} handleClick={handleClick} />
//         ))}
//       </div>
//       {winner && <button className="btn btn-primary mt-3" onClick={resetGame}>Play Again</button>}
//     </div>
//   );
// };
